...
export type IsigV4Client = {
  newClient: (config: InewClientConfig) => { signRequest: (obj: any) => { headers: { Authorization: string }; url: string } }
}

export const sigV4Client: Partial<IsigV4Client> = {}
